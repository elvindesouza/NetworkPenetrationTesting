...
Results from this penetration test were used to secure the network devices and systems on it in the next project [Hardening a Small Network](https://github.com/elvindsouza/hardening)
...
_more details are covered in my [subsequent project](https://github.com/elvindsouza/hardening), where I used the results from this process to harden systems on the same network_
